  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved worker as @worker" do
        ...
        post :create, {:worker => { "name" => "invalid value" }}, valid_session
        assigns(:worker).should be_a_new(Worker)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested worker" do
        ...
        Worker.any_instance.should_receive(:update_attributes).with({ "name" => "MyString" })
        put :update, {:id => worker.to_param, :worker => { "name" => "MyString" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the worker as @worker" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Worker.any_instance.stub(:save).and_return(false)
        put :update, {:id => worker.to_param, :worker => { "name" => "invalid value" }}, valid_session
        assigns(:worker).should eq(worker)
      end
